...
if __name__ == "__main__":
    ...
    joint_indices = [0, 1, 2,3]  # indices of the first three joints
    # Set the target joint positions
    target_positions = [0.2, -0.3, 1.4,2]  # target positions for the first three joints
    # print(pybullet.getNumJoints(robot_id, 2))
    # FK_control(pgui, robot_id, joint_indices, target_positions)
    # joint_indices = list(range(pybullet.getNumJoints(robot_id, 2)))
